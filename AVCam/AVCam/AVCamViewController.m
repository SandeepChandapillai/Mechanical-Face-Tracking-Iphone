...
- (void)viewDidLoad
{
    ...
    //MINE
    UIImage *myImage = [UIImage imageNamed:@"lena.png"];
	...
	dispatch_async(sessionQueue, ^{
        ...
        // This displays the video on the screen ....
...
- (IBAction)backUI:(UIButton *)sender {
...
{
    [self performSegueWithIdentifier:@"nextUIfromCamera" sender:sender ];
}
